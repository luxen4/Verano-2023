...
$pueblaBARRESTAURANTES="INSERT INTO BARRESTAURANTES(ref_negocio,ruta_imagen1,ruta_imagen2,ruta_imagen3,
                                                    ...
                                                    e_tripadvisor,e_facebook,e_web, e_restaurantGuru,e_theFork,menu_Basico,menu_Premium,menu_Personal,dto,habilitado)
...
if (mysqli_query($conn, $pueblaBARRESTAURANTES)) {
    echo "Inserción en la tabla BARRESTAURANTES(Laredo) exitosa <br>";
  } else {
    echo "Error al insertar en la tabla BARRESTAURANTES(Laredo): " . mysqli_error($conn) . "<br>";
  }
