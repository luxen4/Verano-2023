...
if (mysqli_query($conn, $pueblaBARRESTAURANTES)) {
    echo "Inserción en la tabla BARRESTAURANTES(San Juan de Luz) exitosa <br>";
  } else {
    echo "Error al insertar en la tabla BARRESTAURANTES(San Juan de Luz): " . mysqli_error($conn) . "<br>";
  }
