...
'Orioko Barra','Carne Mediterránea y Barbacoa',943106474,
...
'Balea Jatetxea','Comida Mediterránea Y Española',943841620,
...
if (mysqli_query($conn, $pueblaBARRESTAURANTES)) {
    echo "Inserción en la tabla BARRESTAURANTES(Orio) exitosa <br>";
  } else {
    echo "Error al insertar en la tabla BARRESTAURANTES(Orio): " . mysqli_error($conn) . "<br>";
  }
