...
require_once $_SERVER['DOCUMENT_ROOT']   . TEMPORADA . '/app/utilidades/constantes.inc'; 
include $_SERVER['DOCUMENT_ROOT'] . CONEXIONBASEDEDATOS; 
 	$ref_agenciaViajes=$_POST['ref_AgenciaViajes'];
    $ref_Cliente=$_POST['ref_Cliente'];

    require $_SERVER['DOCUMENT_ROOT']   . TEMPORADA . '/fuente/Repositorio/ClienteRepositorio.inc'; 
