<div class="col-xl-3 text-center col-lg-12 col-md-12 col-sm-12 col-12">
    <input id="<?php echo $ref_negocio; ?>" href="#ventana_crearDescuento" data-toggle="modal"  type="button" value="Crear Descuento!">   
</div>

<div class="modal fade" id="ventana_crearDescuento" style="margin: 0 auto;">
    <div class="modal-dialog">
        <div class="modal-content" style="max-width: 380px;" >

            <!-- Header de la ventana-->
                <div class="modal-header">   
                    <h6 class="modal-title">Crear Descuento: </h6>  
                ...
                <form id="form_menu_descuento" action="" method="POST">     
                    <div class="row">
                        <div style="margin: auto;" class="col-xl-11 text-center col-lg-11 col-md-11 col-sm-11 col-11">
                            ...
                            <select id="" style="width: 50%;" name="datos[descuento]" >
                    ...
                    <div class="row">
                        <div class="col-xl-12 text-center col-lg-12 col-md-12 col-sm-12 col-12">
                            <label for="asegura">
                            <input style="width: 1em;" id="asegura" type="checkbox" name="asegura"> Quiero añadir Descuento.</label>
                        </div>
                    </div>

                    <div class="row">
                        <div style="margin: auto;" class="col-xl-11 text-center col-lg-11 col-md-11 col-sm-11 col-6">
                            <input type="submit" class="btn btn-primary" name="creardescuento" value="Crear Descuento">
                        </div>
