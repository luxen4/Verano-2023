    ...
    <div id="" class="col-xl-12 text-center col-lg-12 col-md-12 col-sm-12 col-12">
        ...
        <div class="row">
            ...
            <div class="col-xl-4 text-left col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <input id="importepasajero" type="number" name="datos[importepasajero]"  value="<?php echo $destino[0]['euros']; ?>" placeholder="12 euros" size="6" required min="10" max="50"> <br>
