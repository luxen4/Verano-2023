      ...
      <div class="col-xl-12 text-center">
        ...
        <div class="row">                
          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">  
            <select style="width: 40%;" name="datos[ref_Localidad]" required>
            ...
            <?php if(isset($datos)){if(isset($errores['busasignado'])){?><span class="error"><?= $errores['busasignado'].'</span>'?><?php 
              ...
              <div style="padding: 0em;" class="row">
                  <div id="botones" class="col-xl-12 text-center col-lg-12 col-md-12 col-sm-12 col-12">
                      <input type="submit" name="nuevodestino" value="Crear Destino">
                      <input type="reset" value="Limpiar">
                  </div> 
              </div>

<span style="color: red; margin-top:1em;"> Consulte con el administrador para Localidades no registradas</span>
